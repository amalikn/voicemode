...
```toml
[project.scripts]
voice-mode = "python_voicemode.cli:python_voicemode"
voicemode = "python_voicemode.cli:python_voicemode"
```
Both commands map to the `python_voicemode()` function in the CLI module.

### 2. CLI Entry Function
**File:** `python_voicemode/cli.py`
**Function:** `python_voicemode()`
**Lines:** 74-76
```python
...
### 3. Main CLI Group
**File:** `python_voicemode/cli.py`
**Function:** `python_voicemode_main_cli()`
**Lines:** 40-72
...
**File:** `python_voicemode/cli.py`
**Decorator:** `@python_voicemode_main_cli.command()`
**Function:** `converse()`
**Lines:** 1650-1815
...
**File:** `python_voicemode/tools/converse.py`
**Decorator:** `@mcp.tool()`
**Function:** `converse()`
...
Key imports:
- Line 61-70: Core functions from `python_voicemode.core`
- Line 60: Provider registry from `python_voicemode.provider_discovery`
- Line 28: Conversation logger

### 6. Core Audio Functions
**File:** `python_voicemode/core.py`
...
**File:** `python_voicemode/provider_discovery.py`
...
```bash
# Show the python_voicemode() entry point
show python_voicemode/cli.py:74-76
look  # Confirm visible

# Show the main CLI group
show python_voicemode/cli.py:40-72
look  # Confirm visible
```
...
show python_voicemode/cli.py:1650-1700
look  # Confirm visible
...
show python_voicemode/tools/converse.py:1194
look  # Confirm visible

# Show the key imports
show python_voicemode/tools/converse.py:1-100
look  # Confirm visible
```
...
show python_voicemode/provider_discovery.py
look  # Confirm visible
```
...
converse("When you run voicemode converse, it calls python_voicemode function in cli.py", wait_for_response=False)
...
User runs: voicemode converse
    ↓
pyproject.toml (scripts) → python_voicemode.cli:python_voicemode
    ↓
cli.py:python_voicemode() → python_voicemode_main_cli()
    ↓
