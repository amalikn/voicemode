...
class TestConfigEditCommand:
    ...
    def test_config_edit_help(self):
        ...
        runner = CliRunner()
        result = runner.invoke(python_voicemode_main_cli, ['config', 'edit', '--help'])
    ...
    def test_config_edit_help_short_option(self):
        ...
        runner = CliRunner()
        result = runner.invoke(python_voicemode_main_cli, ['config', 'edit', '-h'])
    ...
    def test_config_command_lists_edit(self):
        ...
        runner = CliRunner()
        result = runner.invoke(python_voicemode_main_cli, ['config', '--help'])
