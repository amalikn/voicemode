...
from python_voicemode.prompts.release_notes import release_notes_prompt
...
"""
    ...
    with patch("python_voicemode.prompts.release_notes.changelog_resource") as mock_resource:
