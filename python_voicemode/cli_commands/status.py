    ...
    if status == "local":
        ...
        try:
            ...
            if platform.machine() == "arm64" and platform.system() == "Darwin":
                from python_voicemode.utils.services.whisper_version import check_coreml_model_exists
            ...
            try:
                from python_voicemode.utils.services.whisper_version import get_whisper_version_info
