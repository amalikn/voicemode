...
from python_voicemode.version import __version__, get_git_commit_hash, is_git_repository
import platform
import sys
import os
...
async def get_version_info() -> str:
    ...
    if is_git_repository():
        ...
        try:
            import python_voicemode
            if hasattr(python_voicemode, "__file__"):
                module_path = python_voicemode.__file__
