...
def setup_logging() -> logging.Logger:
    ...
    if TRACE_DEBUG:
        ...
        def trace_calls(frame, event, arg):
            if event == 'call':
                code = frame.f_code
                if 'voicemode' in code.co_filename or 'python_voicemode' in code.co_filename:
...
def initialize_soundfonts():
    ...
    try:
        ...
        try:
            ...
            package_soundfonts = files("python_voicemode.data.soundfonts.default")
            ...
            if pkg_resources.resource_exists("python_voicemode", resource_dir):
