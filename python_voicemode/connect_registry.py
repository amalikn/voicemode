"""
DEPRECATED: Use python_voicemode.connect.client instead.

This module is retained for backward compatibility. The functionality has been
refactored into the python_voicemode.connect package (types, config, users, messaging,
presence, client).

See: python_voicemode/connect/client.py for the replacement ConnectClient class.
"""
